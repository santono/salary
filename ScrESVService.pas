...
{$IFDEF  SVDN}
  ...
  function TPersonRec6Service.addZO(ZO:Integer;payTp:Integer=0;payYear:Integer=0;payMnth:Integer=0;otk:Integer=1;kdNp:Integer=0):Boolean;
    var curr_cn:CN_PTR;
