object FormPivotDolg: TFormPivotDolg
  ...
  object pFIBDataSetPivotDolg: TpFIBDataSet
    ...
    SelectSQL.Strings = (
        ...
        'select b.prim,c.name as namedol,d.shifrpod,d.name as namepod,a.s' +
        'hifrgru,f.name as namecou, count(*),sum(e.summa) as summakoe,sum' +
        '(a.oklad) as summaokl from person a'
