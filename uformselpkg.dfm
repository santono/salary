object FormSelPKG: TFormSelPKG
  ...
  object pFIBDataSetPodr: TpFIBDataSet
    SelectSQL.Strings = (
      ...
      ''
      'WHERE '
      '    POSITION('#39#1055#1059#1057#1058#1054#1045#39' in UPPER(POD.NAME))=0'
      '    and'
      '    POSITION('#39#1056#1045#1047#1045#1056#1042#39' in UPPER(POD.NAME))=0'
      'ORDER BY SHIFRPOD')
    AllowedUpdateKinds = []
  ...
  object PopupMenu1: TPopupMenu
    ...
    object N2: TMenuItem
      Caption = #1042#1099#1073#1088#1072#1090#1100' '#1080#1079' '#1096#1072#1073#1083#1086#1085#1072' '#1089#1086#1093#1088#1072#1085#1077#1085#1085#1099#1093
      OnClick = N2Click
    end
  end
end
