...
type
  TFormRepWorkers2020 = class(TForm)
    BitBtn1: TBitBtn;
    BitBtn2: TBitBtn;
...
var
  FormRepWorkers2020: TFormRepWorkers2020;
...
procedure TFormRepWorkers2020.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
      Action:=caFree;
end;
function TFormRepWorkers2020.initListPlanRecs:boolean;
  var fi:system.text;
      fname:string;
      line:string;
      s,s1:string;
      ...
      rec:pIniRec;
begin
     fname:=CDIR+'PlanWorkers2020.txt';
...
procedure TFormRepWorkers2020.FormCreate(Sender: TObject);
begin
...
procedure TFormRepWorkers2020.BitBtn1Click(Sender: TObject);
begin
...
procedure TFormRepWorkers2020.CreateReport;
...
procedure TFormRepWorkers2020.fillPerson(curr_person:person_ptr);
  const lenArray=9;
...
procedure TFormRepWorkers2020.moveToExcel;
  var
    ExRow,ExCol:integer;
    i:Integer;
    currPod:Integer;
...
procedure TFormRepWorkers2020.SwodToExcel;
const maxKat=10;
var
    S:String;
