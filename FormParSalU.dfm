object FormParSal: TFormParSal
  ...
  object PanelRepECB: TPanel
    ...
    Caption = 'PanelRepECB'
    TabOrder = 11
    object ButtonRepECB: TButton
      Left = 8
      Top = 0
      Width = 177
      Height = 65
      Caption = #1059#1089#1090#1072#1085#1086#1074#1082#1080' '#1074#1086#1079#1084#1086#1078#1085#1086#1089#1090#1080' '#1089#1086#1079#1076#1072#1074#1072#1090#1100'  '#1086#1090#1095#1077#1090' '#1087#1086' '#1045#1057#1042' '#1087#1086' '#1089#1090#1072#1088#1086#1084#1091
      TabOrder = 0
