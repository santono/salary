...
type
  TFormReMakeSZNadb2014 = class(TForm)
  ...
  private
    ...
    function  MoveNadbVysl(WantedShifr:integer):integer;
...
var
  FormReMakeSZNadb2014: TFormReMakeSZNadb2014;
...
procedure TFormReMakeSZNadb2014.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
     Action:=caFree;
end;

procedure TFormReMakeSZNadb2014.BitBtn2Click(Sender: TObject);
begin
      Application.CreateForm(TFormSelPKG,FormSelPKG);
      FormSelPKG.ShowModal;
end;

procedure TFormReMakeSZNadb2014.BitBtn1Click(Sender: TObject);
 var RetVal:Integer;
begin
     Exit;
...
procedure TFormReMakeSZNadb2014.FormCreate(Sender: TObject);
begin
     Label1.Caption:='';
     Label2.Caption:='';
end;

function TFormReMakeSZNadb2014.MoveNadb:integer;
...
procedure TFormReMakeSZNadb2014.MoveSZPerson(Curr_Person:Person_Ptr;var NeedPut:boolean;WantedShifr:integer);
  var Curr_Cn:CN_PTR;
      Curr_Add:ADD_PTR;
      New_Cn:CN_PTR;
      New_Add:ADD_PTR;
...
function TFormReMakeSZNadb2014.FindPersonFor(Curr_Person:Person_Ptr):Person_Ptr;
...
procedure TFormReMakeSZNadb2014.MoveVyslPerson(Curr_Person:Person_Ptr;var NeedPut:boolean;WantedShifr:integer);
  var Curr_Cn:CN_PTR;
      Curr_Add:ADD_PTR;
      New_Cn:CN_PTR;
      New_Add:ADD_PTR;
...
function TFormReMakeSZNadb2014.MoveNadbVysl(WantedShifr:integer):integer;
 var I_Podr,Cnt  : Integer;
     NSRVTmp,NMESTmp : Integer;
     RetVal      : Integer;
     NeedPut     : Boolean;
              ...
              while (Curr_Person<>Nil) do
                 begin
                      ...
                      if Curr_Person^.automatic=automatic_mode then
                         MoveVyslPerson(Curr_Person,NeedPut,WantedShifr);
                      Application.ProcessMessages;
                      Curr_Person:=Curr_Person.Next;
                 end;
              i_c_2:=Count_Person;
...
procedure TFormReMakeSZNadb2014.BitBtn4Click(Sender: TObject);
 var RetVal : Integer;
     WantedShifr:Integer;
begin
     ...
     RetVal:=MoveNadbVysl(WantedShifr);
     if RetVal>0 then
        ShowMessage('Перенесено '+IntToStr(RetVal)+' надбавок.');
     Close;
...
procedure TFormReMakeSZNadb2014.BitBtn5Click(Sender: TObject);
 var I_Podr,Cnt:Integer;
     NSRVTmp,NMESTmp:Integer;
     RetVal :Integer;
     NeedPut:Boolean;
