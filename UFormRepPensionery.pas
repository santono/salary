        ...
        begin
             ...
             if i=1 then
                begin
                     ...
                     E.WorkBooks[1].WorkSheets[1].Cells[ExRow,2] := 'ИНН';
                     E.WorkBooks[1].WorkSheets[1].Cells[ExRow,3] := 'ФИО';
                     E.WorkBooks[1].WorkSheets[1].Cells[ExRow,4] := 'Начислено';
                     E.WorkBooks[1].WorkSheets[1].Cells[ExRow,5] := 'ЕСН';
