...
{                                                                         }
{                        Version: 1.1  (07.01.2010)                       }
{                                                                         }
{                 Derived from the RSA Data Security, Inc.                }
{                                                                         }
{            MD5 Message-Digest Algorithm described in RFC 1321           }
{                                                                         }
{                    Copyright © 2003, 2010 JetProjects                   }
{                                                                         }
{                  ICQ: 509550; e-mail: jack@uzl.tula.net                 }
{                                                                         }
{             Donate: WebMoney - R174116563942, Z311074530110             }
{                      Yanmex A"l'i'u"a(c( - 41001518658678                     }
{                                                                         }
{     L'n'e"c( y'n(i^n( e(i^a"o'e"u" d(i^e(i^a( a^r'e(, d(i^c'r'e"o'e'n'n(r' d(i^a"a"l'?c'c(n(l' ?r'c,?r'a'i^n(?c(e;i^a^     }
{             y'n(i^a(i^ d(?i^l'e;n(r'. I'i^e(l'?r' e;i^r(l'e"u"e;i^a^ o'e;r'c,r'i'i'u" a^u"r(l'.              }
{   C,r'?r'a'i^n(i^e; a^ n'l'n(c( - http://web-ip.ru/index.php?refwmid=736404714707    }
{ *********************************************************************** }
{$Q-}
...
procedure InitCurrContext;
procedure UpdateCurrContext(Input: PByteArray;InputLen: LongWord);
procedure FinalCurrContext;
function MD5CurrDigestToStr: string;
function testmd5(s:string):string;
...
var currContext:TMD5Context;
    currDigest: TMD5Digest;
...
procedure UpdateCurrContext(Input: PByteArray;InputLen: LongWord);
 begin
      Update(currContext,Input,InputLen);
 end;
...
function MD5CurrDigestToStr: string;
 begin
      MD5CurrDigestToStr:=MD5DigestToStr(CurrDigest);
 end;
