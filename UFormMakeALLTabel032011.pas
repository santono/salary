...
begin
    ...
    if not YesNo('Внести корректировки в табель университета в сентябре 2023?'+#13+#10+'(Если не знаете , что это. Лучше выйти.)') then
       begin
    ...
    IF not ((CurrYear=2023) and (nmes=09)) THEN
       begin
            ShowMessage('Внести корректировки можно только в сентябре 2023');
            BitBtn1.Enabled:=true;
            Exit;
       end;
